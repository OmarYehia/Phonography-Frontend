...
export class Post extends Component {
  ...
  render() {
    ...
    return !this.state.onePostSelected ? (
      <Card>
        <Card.Title>
          <ListItem
        ...
        <View style={{ flexDirection: "row", justifyContent: "space-around" }}>
          <TouchableOpacity
            ...
            {this.state.liked ? (
              <AntDesign name="heart" size={20} color="#f01d71" />
            ) : (
              <AntDesign name="hearto" size={20} color="#f01d71" />
            )}
          </TouchableOpacity>
          <TouchableOpacity
            style={{ flex: 1, alignItems: "center" }}
            onPress={() => this.setState({ disabled: !this.state.disabled, comment: null })}>
      ...
      <Modal animationType="slide" visible={this.state.onePostSelected}>
        <MaterialIcons
          name="close"
          size={24}
